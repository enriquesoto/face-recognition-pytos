...
class Main:
  ...
  def startFromDirectory(self):
    ...
    for file in listing:
      ...
      self.faceCascade = cv2.CascadeClassifier(self.settingsCascade)
            #faceCascade = cv2.CascadeClassifier(constants.HAAR_CASCADE_FILE)
  ...
  @staticmethod
  @offload({'resources/haarcascade_frontalface_alt.xml'})
